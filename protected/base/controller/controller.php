...
class controller{
	...
	/**
	 * $tpl: 模板的名称，例如: index_index
	 * $return: 显示还是返回；true: 作为字符串返回； false： 直接显示在页面上
	 * $is_tpl: true: 直接显示； false： 相当于assign
	 * $include_layout: 模板是否包含layout文件；如果输出不需要头部和尾部，可以设置成false
	 * */
