...
class Config{
	static public $config=array(		
		...
		'APP' => array(
				...
				'AUTOLOAD_DIR' => array(),	//自动加载扩展目录，2.0添加
				),
		...
		'DB'  => array(								
				...
				'DB_CACHE_TYPE' => 'FileCache',//缓存类型，FileCache或Memcache或SaeMemcache，2.0添加
				...
				//memcache配置，可配置多台memcache服务器，2.0添加
		...
		'TPL' => array(
				...
				'TPL_CACHE_TYPE'=>'',//数据缓存类型，为空或Memcache或SaeMemcache，其中为空为普通文件缓存，2.0添加
