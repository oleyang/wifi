...
<div class="list_head_m">
		<div class="list_head_ml">你当前的位置：【添加会员组】</div>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1"  class="all_cont">
            ...
            <tr>
               ...
               <td><textarea name="notallow" cols="60" rows="10"></textarea></td>
               <td class="inputhelp">应用/控制器/方法,键=值/键=值/键=值....<回车></td>
            </tr>
			<tr>
				<td width="200">&nbsp;</td>
				<td align="left" colspan="2"><input type="submit" value="添加" class="button"></td>
			</tr>
			</form>
		</table>
        </div>
